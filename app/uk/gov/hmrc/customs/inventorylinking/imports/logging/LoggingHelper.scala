...
import uk.gov.hmrc.customs.inventorylinking.imports.model.{Ids, MaybeIds, SeqOfHeader}
...
object LoggingHelper {
  ...
  def formatWarn(msg: String, maybeIds: MaybeIds = None)(implicit hc: HeaderCarrier): String = {
    formatInfo(msg, None)
  }
