...
//  private val rdWrapper: ValidatedRequest[AnyContent] = ValidatedRequest[AnyContent](requestMock, mock[HeaderCarrier])
...
//
//      rdWrapper.rdWrapper.requestedApiVersion equals "1.0"
//    }
//
...
//
//      rdWrapper.rdWrapper.requestedApiVersion equals "NOT_FOUND"
//    }
//
...
//
//      rdWrapper.rdWrapper.clientId equals "NOT_FOUND"
//    }
//
//    "create a conversationId" in {
//      rdWrapper.rdWrapper.conversationId shouldNot be(defaultUuid)
//    }
//
//    "create a correlationId" in {
//      rdWrapper.rdWrapper.getClass shouldNot be(defaultUuid)
//    }
//
//    "correlationId is not the same as conversationId" in{
//      rdWrapper.rdWrapper.correlationId shouldNot be(rdWrapper.rdWrapper.conversationId)
//    }
//
//    "dateTime is created in utc" in {
//      rdWrapper.rdWrapper.dateTime.getZone shouldBe DateTimeZone.UTC
//    }
//
...
//      rdWrapper.rdWrapper.badgeIdentifier shouldBe None
//    }
//
...
//      ValidatedRequest[AnyContent](requestMock, mock[HeaderCarrier]).badgeIdentifier shouldBe Some("some-badge-id")
//    }
//  }
//}
