...
object TestData {
  ...
  val XClientIdHeaderName = "X-Client-ID" //TODO replace
  val XConversationIdHeaderName = "X-Conversation-ID" //TODO replace
  val XCorrelationIdHeaderName = "X-Correlation-ID" //TODO replace
